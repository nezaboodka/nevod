...
{
    internal sealed class OutsideExpression : CompoundExpression
    {
        public Expression Body { get; }
        public PatternReferenceExpression OuterPattern { get; }

        public OutsideExpression(Syntax syntax, Expression body, PatternReferenceExpression outerPattern)
            : base(syntax)
        {
            Body = body;
        ...
        {
            var result = candidateFactory.CreateOutsideCandidate(this);
            return result;
        }

        protected internal override void Accept(ExpressionVisitor visitor)
        {
            visitor.VisitOutside(this);
        }
    }
}
